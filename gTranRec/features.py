...
class SExtractor():
    ...
    def create_config(self, thresh=2):
        """
        ...
        conf_args['DETECT_THRESH'] = str(int(thresh))
        conf_args['ANALYSIS_THRESH'] = str(int(thresh))
        conf_args['PIXEL_SCALE'] = '1.24198'
        conf_args['BACK_TYPE'] = 'AUTO'
        conf_args['DETECT_MINAREA'] = '5'
        conf_args['DEBLEND_NTHRESH'] = '32'
        conf_args['DEBLEND_MINCONT'] = '0.005'
    ...
    def run(self, thresh=2):
        ...
        # create config files 
        self.create_config(thresh=thresh)
